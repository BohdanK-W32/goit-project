...
function () {
  ...
  _createClass(FormCheck, [{
    ...
    value: function handleSubmit(e) {
      ...
      if (checkName(nameValue) && checkEmail(emailValue) && checkPhone(phoneValue)) {
        alert('All right!');
        location.reload();
...
var settings = {
  src: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2588.2935568332846!2d25.59044531573671!3d49.554483979361805!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDnCsDMzJzE2LjEiTiAyNcKwMzUnMzMuNSJF!5e0!3m2!1suk!2sus!4v1568989809713!5m2!1suk!2sus',
  width: '100%',
  frameborder: '0',
  style: 'border:0;'
};

var insertMap = function insertMap(_ref) {
  var src = _ref.src,
      width = _ref.width,
      frameborder = _ref.frameborder,
      style = _ref.style;
  var mapSect = document.getElementById('mapSection');
  var mapHeight = parseInt(window.outerHeight * 0.75);
